"""
🎬 DATA PREPROCESSING — V2 : 1249 films  — dataset augmenté (+250)
CSV source : imdb_top_1000_augmente.csv
Sortie     : data/v2/
"""
...
CSV_FILE  = 'imdb_top_1000_augmente.csv'
VERSION   = 'v2'
LABEL     = '1249 films  — dataset augmenté (+250)'
